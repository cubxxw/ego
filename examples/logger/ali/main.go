...
`
	...
	logger.Info("aaaaaaaaa", elog.Any("map", map[string]any{"aaa": "AAA", "bbb": "BBB"}), elog.Any("slice", []string{"ccc", "ddd"}))
	logger.Info("aaaaaaaaa", elog.Any("map", map[string]any{"ccc": "CCC"}))
	defer logger.Flush()
